...
class ProjectsListViewController:  UINavigationController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
//          let controller = UINavigationController(rootViewController: WorkLogsListViewController())
